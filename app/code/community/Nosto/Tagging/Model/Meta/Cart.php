...
/**
 * Meta data class for cart.
 *
 * @category Nosto
 * @package  Nosto_Tagging
 * @author   Nosto Solutions Ltd <magento@nosto.com>
 */
class Nosto_Tagging_Model_Meta_Cart extends Nosto_Tagging_Model_Base
{

    /**
     * @var array items in cart
     */
    public $items = array();
     ...
     */
    public function loadData(Mage_Checkout_Model_Cart $cart)
    {

        // ToDo - Implement cart object and line item object - similar to order and product
